...
# 이미지 리스트 생성
image_list = [image1, image3, image5, image7]
...
text_rect.center = (width // 2, height // 2 * 0.1)

text2 = font.render(
    "Battle with 3 computer players", True, (0, 0, 0))
text_rect2 = text2.get_rect()
text_rect2.center = (width // 2, height // 2 * 0.1)

text3 = font.render(
    "Battle with 2 computer players", True, (0, 0, 0))
text_rect3 = text3.get_rect()
text_rect3.center = (width // 2, height // 2 * 0.1)

text4 = font.render(
    "Battle with 4 computer players", True, (0, 0, 0))
text_rect4 = text4.get_rect()
text_rect4.center = (width // 2, height // 2 * 0.1)
...
button_rect = pygame.Rect(
    (width // 2 * 0.8, height // 2 * 1.7), (width // 5, height // 15))
...
def create_popup():
    popup_window = pygame_gui.windows.UIConfirmationDialog(
        rect=pygame.Rect(
            (width//2 * 0.5, height//2 * 0.6), (450, 250)),
        manager=manager,
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if event.key == pygame.K_LEFT:
                selected_index = (selected_index - 1) % num_images
                if selected_index == 0:
                    current_image4 = image8
                    current_image2 = image3
                    current_image3 = image5
        ...
        if current_image == image2:
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_RETURN:
                    popup_window = create_popup()

        if current_image2 == image4:
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_RETURN:
                    popup_window = create_popup2()

        if current_image3 == image6:
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_RETURN:
                    popup_window = create_popup3()

        if current_image4 == image8:
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_RETURN:
                    popup_window = create_popup4()

            if event.type == pygame.USEREVENT:
                if popup_window and event.type == pygame_gui.UI_CONFIRMATION_DIALOG_CONFIRMED:
                    if event.ui_object == popup_window:
                        popup_window.kill()
                        popup_window = None
